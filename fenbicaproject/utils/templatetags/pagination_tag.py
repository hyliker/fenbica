...
class PaginationNode(Node):
  def __init__(self, view_var, objects_var, page_var, step, segment, variable):
  ...
  def render(self, context):
    ...
    view = template.resolve_variable(self.view_var, context)
    ...
    try:
      ...
      context['pagination'] = Pages(view, page, pages, self.segment)
    except:
      pass
